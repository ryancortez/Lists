...
- (UITableViewCellEditingStyle)tableView:(UITableView *)tableView editingStyleForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.editing && indexPath.row == _list.listItems.count) {
...
-(void)tableView:(UITableView *)tableView moveRowAtIndexPath:(NSIndexPath *)sourceIndexPath toIndexPath:(NSIndexPath *)destinationIndexPath {
    ...
    listItem = list.listItems[sourceIndexPath.row];
    [list.listItems removeObjectAtIndex:sourceIndexPath.row];
    [list.listItems insertObject:listItem atIndex:destinationIndexPath.row];
    [self saveListsToUserDefault];
